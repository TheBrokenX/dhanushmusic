...
from DhanushX import app
from DhanushX.misc import db
from DhanushX.utils import (Anonbin, get_channeplayCB,
                              seconds_to_min)
from DhanushX.utils.database import (get_cmode, is_active_chat,
                                       is_music_playing)
from DhanushX.utils.decorators.language import language, languageCB
from DhanushX.utils.inline import queue_back_markup, queue_markup
...
async def queued_tracks(client, CallbackQuery: CallbackQuery, _):
    ...
    med = InputMediaPhoto(
        media="https://graph.org/file/c7c853c0c30b62b4c2eaf.jpg",
        caption=_["queue_1"],
    )
