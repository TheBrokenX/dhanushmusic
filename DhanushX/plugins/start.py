...
from DhanushX import Telegram, YouTube, app
from DhanushX.misc import SUDOERS, _boot_
from DhanushX.plugins.playlist import del_plist_msg
from DhanushX.plugins.sudoers import sudoers_list
from DhanushX.utils.database import (add_served_chat,
                                       add_served_user,
                                       get_served_chats,
                                       get_served_users,
                                       blacklisted_chats,
...
from DhanushX.utils.decorators.language import LanguageStart
from DhanushX.utils.formatters import get_readable_time
from DhanushX.utils.inline import (help_pannel, private_panel,
                                     start_pannel)
...
async def start_comm(client, message: Message, _):
    ...
    if len(message.text.split()) > 1:
        ...
        if name[0:4] == "help":
            ...
            await message.reply_sticker("CAACAgUAAxkBAAEJr6RksQaIkI1MxwABxEr272ZrfWlaRvIAAooLAALaiYhVFt3dpks2WWgvBA")
